...
const showRequisitesBtn = document.getElementById('showRequisites');
const closeModalBtn = document.querySelector('.close-modal');
const pdfViewer = document.getElementById('pdfViewer');
const downloadPdf = document.getElementById('downloadPdf');

// Укажите путь к вашему PDF-файлу
const pdfPath = 'docs/requisites.pdf';

showRequisitesBtn.addEventListener('click', () => {
    pdfViewer.src = pdfPath;
    downloadPdf.href = pdfPath;
    requisitesModal.style.display = 'block';
});

closeModalBtn.addEventListener('click', () => {
    requisitesModal.style.display = 'none';
    pdfViewer.src = '';
});
...
const closeLicensesModalBtn = licensesModal.querySelector('.close-modal');

showLicensesBtn.addEventListener('click', () => {
    licensesModal.style.display = 'block';
});

closeLicensesModalBtn.addEventListener('click', () => {
...
// Обработчик для закрытия модального окна лицензий
document.querySelector('#licensesModal .close-modal').addEventListener('click', function() {
  document.getElementById('licensesModal').style.display = 'none';
});
